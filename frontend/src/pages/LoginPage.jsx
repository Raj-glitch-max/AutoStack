...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--bg-base)' }}>
            {/* Authentication Card */}
            <div className="relative z-10 w-full max-w-[400px] bg-[var(--bg-card)] border border-[var(--border-default)] rounded-2xl shadow-2xl overflow-hidden animate-fadeUp">
                ...
                <div className="p-8">
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-[13px] text-[var(--text-muted)] mt-2">Log in to your AutoStack account</p>
                    </div>
